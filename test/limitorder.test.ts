import { Token, CurrencyAmount, LimitOrder, ChainId, ILimitOrderData, Price, FillLimitOrder } from '../src';
...
describe('Limit Order', () => {
    ...
    it('Should calculate order digest', async () => {
      ...
      it('should fill the limit order', () => {
        ...
        new FillLimitOrder(limitOrder, ["0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC", "0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC"], BigNumber.from(amountOut.quotient.toString()), BigNumber.from(amountOut.quotient.toString()), "0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC", "0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC");
