...
export const FLEXUSD: TokenMap = {
  [ChainId.SMARTBCH]: new Token(ChainId.SMARTBCH, FLEXUSD_ADDRESS[ChainId.SMARTBCH], 6, 'flexUSD', 'FlexUSD')
}

export const WETH9: TokenMap = {
  [ChainId.SMARTBCH]: new Token(ChainId.SMARTBCH, WETH9_ADDRESS[ChainId.SMARTBCH], 18, 'BCH', 'Bitcoin Cash'),
  [ChainId.SMARTBCH_AMBER]: new Token(ChainId.SMARTBCH, WETH9_ADDRESS[ChainId.SMARTBCH], 18, 'TBCH', 'Bitcoin Cash')
}
